...
- household 1's capital share `x^1_t / K_t`
- household 2's capital share `x^2_t / K_t`
- the share change `x^1_{t-1}/K_{t-1} - x^1_t/K_t`
- the share change `x^2_{t-1}/K_{t-1} - x^2_t/K_t`
